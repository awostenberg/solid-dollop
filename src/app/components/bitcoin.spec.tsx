...
describe('bitcoin whole value', () => {
    ...
    it('formats 8 decimal digits to the right', () => {
        expect(Bitcoin.fromSats(37_801_991).asDisplayString()).toContain('+ 0.37801991');
    })

    it('pads right with zeros to 8 places', () => {
        expect(Bitcoin.fromSats(1_000_000).asDisplayString()).toContain('+ 0.01000000')
    });

    it('displays no leading zero left of decimal if greater than a whole bitcoin', () => {
        expect(Bitcoin.fromSats(101_000_000).asDisplayString()).toContain('+ 1.01000000');
    });
